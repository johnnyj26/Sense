...
$.validator.addMethod("borrowAmount1",function(value,element){
...
//区号验证
$.validator.addMethod("isPhonePrefix",function(value,element){
	var mobilePhone =/^0\d{2,3}$/;
	return this.optional(element) || (mobilePhone.test(value));
},"请正确填写您的电话号");

//区号固话好
$.validator.addMethod("isPhoneNum",function(value,element){
	var mobilePhone =/^[2-9][0-9]{6,7}$/;
	return this.optional(element) || (mobilePhone.test(value));
},"请正确填写您的电话号");
...
$.validator.addMethod("username", function(value, element) {
	var verify = /^[a-zA-Z_\u4e00-\u9fa5]{1}[0-9a-zA-Z_\u4e00-\u9fa5]{2,17}$/;
